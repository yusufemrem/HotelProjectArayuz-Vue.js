<template>
  ...
  <html lang="en">
    <head>
      ...
      <link rel="stylesheet" href="/html2/css/bootstrap.min.css" />
      <link rel="stylesheet" href="/html2/fontawesome/css/all.min.css" />
      <link rel="stylesheet" href="/html2/css/templatemo-style.css" />
      <!--
    ...
    <body>
      ...
      >
        <form class="d-flex tm-search-form">
          <img src="/img/tatil.jpg" width="100%" />
          <!-- <input
      ...
      <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
          ...
          <div class="col-6 d-flex justify-content-end align-items-center">
            <form action="" class="tm-text-primary">
              - Detaylar İçin Resme Tıklayabilirsiniz
            </form>
          </div>
        </div>
        <div class="row tm-mb-90 tm-gallery">
          ...
          <router-link to="/src/Components/Home/homepage.vue">
            <button class="tm-text-primary">Ana Sayfa</button>
          </router-link>
        </div>
        <!-- row -->
      </div>
